...
;; vim.*
(((dot_index_expression) @field (#eq? @field "vim.cmd"     )) (#set! conceal "Cmd"))
(((dot_index_expression) @field (#eq? @field "vim.api"     )) (#set! conceal "Api"))
(((dot_index_expression) @field (#eq? @field "vim.fn"      )) (#set! conceal "Fn"))
(((dot_index_expression) @field (#eq? @field "vim.g"       )) (#set! conceal "G"))
(((dot_index_expression) @field (#eq? @field "vim.opt"     )) (#set! conceal "opt"))
(((dot_index_expression) @field (#eq? @field "vim.env"     )) (#set! conceal "env"))
...
(((dot_index_expression) @field (#eq? @field "vim.keymap.set")) (#set! conceal "map"))
